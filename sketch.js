...
function setup() {
  ...
  trex = createSprite(displayWidth/4-300,displayHeight-270,20,50);
  trex.addAnimation("running", trex_running);

  //adding camera effect
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(displayHeight/4-100,displayHeight/3+100));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth,displayHeight-260,10,40);
